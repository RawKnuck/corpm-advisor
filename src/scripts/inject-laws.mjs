...
// Standard 48 Laws of Power (parsed directly from the user's PDF screenshots)
const lawsOfPower = [
  {
    law: 1,
  ...
  },
  {
    ...
    summary: "Keep people off-balance and in the dark by never revealing the purpose behind your actions. If they have no clue what you are up to, they cannot prepare a defense. Guide them far enough down the wrong path, envelop them in enough smoke, and by the time they realize your intentions, it will be too late."
  },
  {
    law: 4,
  ...
  },
  {
    ...
    summary: "Reputation is the cornerstone of power. Through reputation alone you can intimidate and win; once it slips, however, you are vulnerable, and will be attacked on all sides. Make your reputation unassailable. Always be alert to potential attacks and thwart them before they happen. Meanwhile, learn to destroy your enemies by opening holes in their own reputations. Then stand aside and let public opinion hang them."
  },
  {
    law: 6,
  ...
  },
  {
    ...
    summary: "If you need to turn to an ally for help, do not bother to remind him of your past assistance and good deeds. He will find a way to ignore you. Instead, uncover something in your request, or in your alliance with him, that will benefit him, and emphasize it out of all proportion. He will respond enthusiastically when he sees something to be gained for himself."
  },
  {
    law: 14,
    title: "Pose as a Friend, Work as a Spy",
    summary: "Knowing about your rival is critical. Use spies to gather valuable information that will keep you a step ahead. Better still: Play the spy yourself. In polite social encounters, learn to probe. Ask indirect questions to get people to reveal their weaknesses and intentions. There is no occasion that is not an opportunity for artful spying."
  },
  {
    law: 15,
...
if (fs.existsSync(essaysPath)) {
  try {
    essays = JSON.parse(fs.readFileSync(essaysPath, 'utf8'));
  } catch (e) {
    console.error('Failed to parse essays.json:', e);
  }
}

// 1. Remove the old unified "The 48 Laws of Power" essay if it exists
essays = essays.filter(e => e.title !== "The 48 Laws of Power");

// 2. Remove any existing split laws to prevent duplicates on repeated runs
essays = essays.filter(e => !e.url.startsWith("https://corpmachiavelli.com/the-48-laws-of-power/"));

// 3. Convert each law into its own individual RAG document
const splitLaws = lawsOfPower.map(l => {
  return {
    title: `Law ${l.law}: ${l.title}`,
    url: `https://corpmachiavelli.com/the-48-laws-of-power/law-${l.law}/`,
    content: `### Law ${l.law}: ${l.title}\n\n${l.summary}`
  };
});

// 4. Append all split laws to the essays array
essays = [...essays, ...splitLaws];

// 5. Write back to essays.json
fs.writeFileSync(essaysPath, JSON.stringify(essays, null, 2));
console.log(`Successfully split and injected ${splitLaws.length} individual laws into the knowledge base.`);
